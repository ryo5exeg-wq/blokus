const CACHE='blokus-v2';
const CORE=['index.html','online.html','blokus_core.js','online_client.js','manifest.webmanifest','online.webmanifest','icon-192.png','icon-512.png','icon-180.png'];
